...
namespace skiagputest
{
    public class AngleControl : HwndHost
    {
        ...
        protected override HandleRef BuildWindowCore(HandleRef hwndParent)
        {
            ...
            ANGLE.InitializeContext((int)Width,(int)Height,windowHandle,User32.GetDC(windowHandle).DangerousGetHandle());
            ...
            var backendRT = new GRBackendRenderTarget((int)Width, (int)Height,0, 8, fbinfo);
            var surfaceprops = new SKSurfaceProperties(SKSurfacePropsFlags.UseDeviceIndependentFonts,
                SKPixelGeometry.Unknown);
            var surface = SKSurface.Create(grContext, backendRT, GRSurfaceOrigin.BottomLeft, SKColorType.Bgra8888,
                null, surfaceprops);
